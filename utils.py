...
def scrollable_frame(parent):
    ...
    """
    scrollable_frame = ctk.CTkScrollableFrame(parent, corner_radius=0, fg_color=("white", "black")) # Crea una instancia de CTkScrollableFrame con el widget padre especificado.
