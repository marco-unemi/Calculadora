...
from core.modelo_SIR import simular_sir
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg

class UIModeloMatematico:
    def __init__(self, workspace_frame):
        ...
        self.t, self.S, self.I, self.R = simular_sir(self.S0_ej, self.I0_ej, self.R0_ej, self.N_ej, self.beta_ej, self.gamma_ej, self.dias_ej)
    ...
    def actualizar_simulacion(self):
        ...
        try:
            ...
            # Simula
            self.t, self.S, self.I, self.R = simular_sir(S0, I0, R0, N, beta, gamma, dias)
            self._build_grafica()
