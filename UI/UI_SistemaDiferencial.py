...
from core.sistema_diferencial import resolver_sistema_diferencial

class UISistemaDiferencial:
    ...
    def calcular(self):
        try:
            ...
            if A is None or X0 is None:
                return
            tabla, valores, vectores, funcs = resolver_sistema_diferencial(A, X0, t0=0, tf=tf, h=h)
